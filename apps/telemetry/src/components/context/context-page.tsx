...
export function ContextPage() {
  ...
  const searchThreadIdentityAsOf = useAction(
    api.agentMemory.searchThreadIdentityAsOf,
  );
  ...
  const [isRecordingThreadEpisode, setIsRecordingThreadEpisode] =
    useState(false);
  const [isSearchingThreadKnowledge, setIsSearchingThreadKnowledge] =
    useState(false);
  const [hasSearchedThreadKnowledge, setHasSearchedThreadKnowledge] =
    useState(false);
    ...
    try {
      ...
      setThreadStatus(
        error instanceof Error
          ? error.message
          : "Current knowledge search failed.",
      );
    } finally {
        ...
        <div className="grid gap-6 xl:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Append a thread-identity episode into the component-owned
                history, facts, and memory stack.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Input
                      ...
                      onChange={(event) =>
                        setThreadMessageId(event.target.value)
                      }
                    />
                  </div>
                  <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Input
                      ...
                      onChange={(event) =>
                        setThreadStaticHash(event.target.value)
                      }
                    />
                  </div>
                  <div className="flex flex-col gap-2 md:col-span-2">
                    ...
                    <Input
                      ...
                      onChange={(event) =>
                        setThreadRuntimeHash(event.target.value)
                      }
                    />
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                <Label htmlFor="thread-as-of">
                  As-of time (ms since epoch)
                </Label>
                <Input
                  id="thread-as-of"
