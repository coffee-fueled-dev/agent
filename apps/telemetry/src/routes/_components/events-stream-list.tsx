...
export type EventsStreamOptionalFilters = {
  eventTypeId?: string;
  streamTypeId?: string;
  eventTimeMin?: number;
  eventTimeMax?: number;
...
export type EventsStreamListProps = {
  scope: EventsStreamScope;
  filters?: EventsStreamOptionalFilters;
  /** `sidebar`: time in tooltip (chat/context). `page`: time inline (events index). */
...
function EventsVirtualizedPage({
  results,
  loadMore,
  canLoadMore,
  isLoadingMore,
...
function EventsVirtualizedSidebar({
  results,
  loadMore,
  canLoadMore,
  isLoadingMore,
...
export function EventsStreamList({
  scope,
  filters,
  variant = "page",
  emptyTitle = "No telemetry events yet.",
}: EventsStreamListProps) {
  ...
  const RowVirtualized =
    variant === "sidebar" ? EventsVirtualizedSidebar : EventsVirtualizedPage;
